...
public class BlogController {
    ...
    //查出当前用户关注人发布的博客
    @GetMapping("/selectAttentionBlogs")
    public Result selectAttention(@RequestParam(defaultValue = "1") Integer pageNum,
                                  @RequestParam(defaultValue = "10") Integer pageSize){
        PageInfo<Blog> page=blogService.selectAttentionBlogs(pageNum,pageSize);
        return Result.success(page);
    }
